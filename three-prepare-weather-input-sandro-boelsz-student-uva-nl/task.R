...
to_date <- locations_input$start_day |>
  as.Date() + locations_input$sim_days
...
weather_file <- paste0(locations_input$location_path, "/weather.txt")
# capturing outputs
