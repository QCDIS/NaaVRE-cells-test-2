...
id <- gsub("\"", "", opt$id)
print("Retrieving param_knmi_edr_api_key")
var = opt$param_knmi_edr_api_key
print(var)
var_len = length(var)
print(paste("Variable param_knmi_edr_api_key has length", var_len))

param_knmi_edr_api_key <- gsub("\"", "", opt$param_knmi_edr_api_key)
...
# capturing outputs
print('Serialization of temperature_file')
