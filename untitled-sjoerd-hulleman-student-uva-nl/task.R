...
make_option(c("--latitude"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--longitude"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--Pelagic_xy"), action="store", default=NA, type="character", help="my description"), 
make_option(c("--ppBen"), action="store", default=NA, type="character", help="my description"), 
make_option(c("--ppPel"), action="store", default=NA, type="character", help="my description"), 
make_option(c("--rad"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--Rad_bottom"), action="store", default=NA, type="numeric", help="my description"), 
...
Kd = opt$Kd
print("Retrieving latitude")
var = opt$latitude
print(var)
var_len = length(var)
print(paste("Variable latitude has length", var_len))

latitude = opt$latitude
print("Retrieving longitude")
var = opt$longitude
print(var)
var_len = length(var)
print(paste("Variable longitude has length", var_len))
...
print("------------------------Running var_serialization for ppBen-----------------------")
print(opt$ppBen)
ppBen = var_serialization(opt$ppBen)
print("---------------------------------------------------------------------------------")
...
print("------------------------Running var_serialization for ppPel-----------------------")
print(opt$ppPel)
ppPel = var_serialization(opt$ppPel)
print("---------------------------------------------------------------------------------")
