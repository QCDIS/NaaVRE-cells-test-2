...
print("Retrieving budburst_climwin_input_file")
var = opt$budburst_climwin_input_file
print(var)
var_len = length(var)
print(paste("Variable budburst_climwin_input_file has length", var_len))
...
id <- gsub("\"", "", opt$id)
print("Retrieving scenario_data_all_file")
var = opt$scenario_data_all_file
print(var)
var_len = length(var)
print(paste("Variable scenario_data_all_file has length", var_len))

scenario_data_all_file <- gsub("\"", "", opt$scenario_data_all_file)
print("Retrieving temp_climwin_input_file")
var = opt$temp_climwin_input_file
print(var)
var_len = length(var)
print(paste("Variable temp_climwin_input_file has length", var_len))
...
validation_plot_all
# capturing outputs
print('Serialization of validation_all_zScores_file')
