...
print("Retrieving netlogo_output")
var = opt$netlogo_output
print(var)
var_len = length(var)
print(paste("Variable netlogo_output has length", var_len))

print("------------------------Running var_serialization for netlogo_output-----------------------")
print(opt$netlogo_output)
netlogo_output = var_serialization(opt$netlogo_output)
print("---------------------------------------------------------------------------------")
