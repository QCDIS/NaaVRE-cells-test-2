...
make_option(c("--biovolume"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--cellcarboncontent"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--conf_output"), action="store", default=NA, type="character", help="my description"), 
...
make_option(c("--param_password"), action="store", default=NA, type="character", help="my description"), 
make_option(c("--surfacearea"), action="store", default=NA, type="numeric", help="my description"), 
make_option(c("--volumeofsedimentationchamber"), action="store", default=NA, type="numeric", help="my description")
)
...
print("Retrieving biovolume")
var = opt$biovolume
print(var)
var_len = length(var)
print(paste("Variable biovolume has length", var_len))

biovolume = opt$biovolume
print("Retrieving cellcarboncontent")
var = opt$cellcarboncontent
print(var)
var_len = length(var)
print(paste("Variable cellcarboncontent has length", var_len))

cellcarboncontent = opt$cellcarboncontent
print("Retrieving conf_output")
var = opt$conf_output
print(var)
var_len = length(var)
print(paste("Variable conf_output has length", var_len))

conf_output <- gsub("\"", "", opt$conf_output)
print("Retrieving formulaforbiovolume")
var = opt$formulaforbiovolume
print(var)
var_len = length(var)
print(paste("Variable formulaforbiovolume has length", var_len))

formulaforbiovolume <- gsub("\"", "", opt$formulaforbiovolume)
print("Retrieving formulaforbiovolumesimplified")
var = opt$formulaforbiovolumesimplified
print(var)
var_len = length(var)
print(paste("Variable formulaforbiovolumesimplified has length", var_len))

formulaforbiovolumesimplified <- gsub("\"", "", opt$formulaforbiovolumesimplified)
print("Retrieving formulaformissingdimension")
var = opt$formulaformissingdimension
print(var)
var_len = length(var)
print(paste("Variable formulaformissingdimension has length", var_len))

formulaformissingdimension <- gsub("\"", "", opt$formulaformissingdimension)
print("Retrieving formulaformissingdimensionsimplified")
var = opt$formulaformissingdimensionsimplified
print(var)
var_len = length(var)
print(paste("Variable formulaformissingdimensionsimplified has length", var_len))

formulaformissingdimensionsimplified <- gsub("\"", "", opt$formulaformissingdimensionsimplified)
print("Retrieving formulaforsurface")
var = opt$formulaforsurface
print(var)
var_len = length(var)
print(paste("Variable formulaforsurface has length", var_len))

formulaforsurface <- gsub("\"", "", opt$formulaforsurface)
print("Retrieving formulaforsurfacesimplified")
var = opt$formulaforsurfacesimplified
print(var)
var_len = length(var)
print(paste("Variable formulaforsurfacesimplified has length", var_len))

formulaforsurfacesimplified <- gsub("\"", "", opt$formulaforsurfacesimplified)
print("Retrieving formulaforweight1")
var = opt$formulaforweight1
print(var)
var_len = length(var)
print(paste("Variable formulaforweight1 has length", var_len))

formulaforweight1 <- gsub("\"", "", opt$formulaforweight1)
print("Retrieving formulaforweight2")
var = opt$formulaforweight2
print(var)
var_len = length(var)
print(paste("Variable formulaforweight2 has length", var_len))

formulaforweight2 <- gsub("\"", "", opt$formulaforweight2)
print("Retrieving id")
var = opt$id
print(var)
var_len = length(var)
...
param_password <- gsub("\"", "", opt$param_password)
print("Retrieving surfacearea")
var = opt$surfacearea
print(var)
var_len = length(var)
print(paste("Variable surfacearea has length", var_len))

surfacearea = opt$surfacearea
print("Retrieving volumeofsedimentationchamber")
var = opt$volumeofsedimentationchamber
print(var)
var_len = length(var)
print(paste("Variable volumeofsedimentationchamber has length", var_len))

volumeofsedimentationchamber = opt$volumeofsedimentationchamber
