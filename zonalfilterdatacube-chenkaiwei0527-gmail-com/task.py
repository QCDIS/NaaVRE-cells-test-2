...
arg_parser.add_argument('--out_DA_maps', action='store', type=str, required=True, dest='out_DA_maps')
...
out_DA_maps = args.out_DA_maps.replace('"','')
...
gris_srs_to_Wkt_path = "EPSG:3035"
maps_path = out_DA_maps
